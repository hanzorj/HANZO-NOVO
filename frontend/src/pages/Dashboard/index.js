...
const useStyles = makeStyles((theme) => ({
  ...
  card9: {
    ...
    flexDirection: "column",
    height: "100%",
    backgroundColor: "#EA7A92",
    color: "#eee",
  },
  cardDataVencimento: {//DATA VENCIMENTO
    padding: theme.spacing(2),
    display: "flex",
    overflow: "auto",
    flexDirection: "row",
      ...
      <Container maxWidth="lg" className={classes.container}>
        <Grid container spacing={3} justifyContent="flex-end">
          ...
          <Grid item xs={12} sm={6} md={12}>
            <Paper square
              className={classes.cardDataVencimento}
              style={{ overflow: "hidden" }}
              elevation={5}
              >
              <Grid container spacing={1} loading={loading}>
                <Grid item xs={12}>
                  <Typography  component="h6" variant="h6" paragraph >Ativo até da data {companyDueDate} </Typography>
                </Grid>
          ...
          <Grid item xs={12} className={classes.alignRight}>
            ...
            {/* DASHBOARD ATENDIMENTOS HOJE */}
              <Grid item xs={12}>
                <Paper square className={classes.fixedHeightPaper}>
                  <Chart />
                </Paper>
              </Grid>
