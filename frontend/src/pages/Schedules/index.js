...
import "./Schedules.css"; // CSS agendamento
  ...
  return (
    <MainContainer >
      ...
      <Paper className={classes.mainPaper} variant="outlined" onScroll={handleScroll}>
        <Calendar className={classes.bgcalendario} 
          ...
          events={schedules.map((schedule) => ({
            title: (
              <div className="event-container">
                <div style={eventTitleStyle} className={classes.nomeagendado}>{schedule.contact.name}</div>
                <DeleteOutlineIcon 
