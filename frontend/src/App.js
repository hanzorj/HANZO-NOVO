    ...
    const theme = createTheme(
        {
            ...
            palette: {
                type: mode,
                primary: { main: "#8731cf" },
                textPrimary: mode === "light" ? "#8731cf" : "#FFFFFF",
                borderPrimary: mode === "light" ? "#8731cf" : "#FFFFFF",
                dark: { main: mode === "light" ? "#333333" : "#F3F3F3" },
                light: { main: mode === "light" ? "#F3F3F3" : "#333333" },
                tabHeaderBackground: mode === "light" ? "#EEE" : "#333",
                optionsBackground: mode === "light" ? "#fafafa" : "#333",
				options: mode === "light" ? "#fafafa" : "#666",
				fontecor: mode === "light" ? "#8731cf" : "#fff",
                ...
                barraSuperior: mode === "light" ? "linear-gradient(to right, #8731cf , #051641)" : "#666",
				boxticket: mode === "light" ? "#EEE" : "#333",
				campaigntab: mode === "light" ? "#ededed" : "#333",
                iconmenulateral: { main: mode === "light" ? "#8731cf" : "#051641" },
            },
            mode,
        },
        locale
